...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//It's a nested function. meaning that the function is within the myfunction.
//because of this, nestedFunction can inherit the info it needs from the function above it
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    namesOfAnimals.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    });
  ...
  */
  ...
  function lowerCaseNames(array){
    const namesLowered = array.map(function(item){
